...
HOOK(void, __fastcall, KeyboardUpdate, 0x1407CCFB0, hh::hid::Keyboard* self, float unkParam)
{
...
HOOK(void, __fastcall, MouseUpdate, 0x1407CE910, hh::hid::MouseWin32* self, float unkParam)
{
...
HOOK(void, __fastcall, BindMaps, 0x14037F490, hh::game::GameManager* gameManager, int64_t a2) {
	originalBindMaps(gameManager, a2);
	auto* inputSettings = *reinterpret_cast<hh::hid::InputMapSettings**>(0x143FBFE78);
